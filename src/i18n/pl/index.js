...
export default {
    ...
    add_new: 'Dodaj nowy',
    search: 'Szukaj',
    search_providers: 'Dostawcy wyszukiwania',
    general: 'Ogólny',
    general_settings: 'Ustawienia ogólne',
    general_settings_more: 'Wybierz ogólne ustawienia systemu',
    search_settings: 'Ustawienia wyszukiwania',
    search_settings_more: 'Wybierz które wyszukiwarki mają być używane',
    dashboard_more: 'Ustawienia dla panelu',
    active: 'Aktywne',
    inactive: 'Nieaktywny',
    appearance: 'Wygląd',
    enhanced: 'Ulepszone',
    ...
    enter_website: 'Wprowadź adres strony',
