...
export default {
  ...
  mfa_intro:
    'Увімкнення цього параметра дозволить використовувати додаток аутентифікації, який підтримує TOTP Коди, якщо у вас ще немає одного, ми рекомендуємо {link1} або {link2}.',
  mfa_above_qr:
